...
#ifndef VIKING_ASSERT_H
#define VIKING_ASSERT_H
...
// Alteratively we could use the same "default" message for both "WITH_MSG" and "NO_MSG" and
	...
	#define VI_INTERNAL_ASSERT_IMPL(type, check, msg, ...) { if(!(check)) { HZ##type##ERROR(msg, __VA_ARGS__); VI_DEBUGBREAK(); } }
	...
	#define VI_INTERNAL_ASSERT_GET_MACRO(...) VI_EXPAND_MACRO( VI_INTERNAL_ASSERT_GET_MACRO_NAME(__VA_ARGS__, HVI_INTERNAL_ASSERT_WITH_MSG, HVI_INTERNAL_ASSERT_NO_MSG) )
